...
<div class="container">    
  <h1>AGREGAR VIDEOJUEGO</h1>
	...
	<form action="conexagregar.php" method="POST">		
		...
		<div class="form-group">
		  ...
		  <input type="text" required class="form-control" id="Plataforma" name="Plataforma">
		</div>

		<div class="form-group">
		  <label for="Desarrolladora">Desarrolladora: </label>
		  <input type="text" required class="form-control" id="Desarrolladora" name="Desarrolladora">
		</div>

		<div class="form-group">
		  <label for="Editora">Editora: </label>
		  <input type="text" required class="form-control" id="Editora" name="Editora">
		</div>
